...
export default function Motivation() {
  return (
    <section className="py-14 bg-gray-100 lg:py-24">
      <div className="container mx-auto px-4 text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 gap-9 lg:gap-6 lg:grid-cols-4 mt-10">
          {motivationItems.map((item) => (
            <div key={item.title} className="flex flex-col items-center lg:items-start">
              <div className="flex justify-center lg:justify-start">
                <img className="w-16 h-16 lg:w-20 lg:h-20" src={item.iconPath} alt={item.title} />
              </div>
